...
Troubleshooting
test2data
When making songs in famitracker, don't use ROWS = 256. text2data (or any variation) won't work right, and will only output empty songs.
...
- Music_Data line 6 of the *name*.S file formate should be *name*_music_data
LDX #<*name*_music_data ;low
LDY #>*name*_music_data ;high
LDA #1 ;NTSC = 1, PAL = 0
JSR FamiToneInit
...
_Should be the first program lin in *name*.s File 
LDX #<sfx_data ;low
LDY #>sfx_data ;high
JSR FamiToneSfxInit
